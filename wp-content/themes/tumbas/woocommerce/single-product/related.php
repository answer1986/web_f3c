...
$per_page = tumbas_get_config('number_product_releated', 4);
...
$woocommerce_loop['columns'] = tumbas_get_config('releated_product_columns', 4);

if ( $products->have_posts() ) : ?>

	<div class="related products widget owl-carousel-top">
	<h3 class="widget-title"><span><?php esc_html_e( 'Related Products', 'tumbas' ); ?></span></h3>
